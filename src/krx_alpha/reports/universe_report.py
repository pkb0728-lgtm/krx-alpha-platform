...
def _format_success_table(frame: pd.DataFrame) -> str:
    ...
    elif has_regime and has_financial and has_event and has_flow:
        rows = [
            "| Rank | Ticker | Action | Confidence | Financial | Event | Flow | Regime | Report |",
            "| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |",
        ]
    elif has_regime and has_financial and has_event:
        rows = [
